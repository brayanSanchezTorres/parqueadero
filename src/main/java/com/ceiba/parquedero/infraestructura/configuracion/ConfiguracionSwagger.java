package com.ceiba.parquedero.infraestructura.configuracion;
...
public class ConfiguracionSwagger {
	...
	private static ApiInfo getApiInfo() {
		return new ApiInfoBuilder().title("Documentacion ApiRest Parqueadero Ceiba").description("Aplicacion que la gestion de un parqueadero")
